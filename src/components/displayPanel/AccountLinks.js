  ...
  return (
    <LinksWrapper>
      <StyledLink href="@">
        ...
        <Content>{location ? location : 'Not Available'}</Content>
      </StyledLink>

      <StyledLink href={handleLink()} target="_blank">
        <svg
          className="svg"
          height="20"
          fill="#4b6a9b"
      ...
      <StyledLink href="@">
        ...
        <Content>{company ? company : 'Not Available'}</Content>
      </StyledLink>
    </LinksWrapper>
  );
};
